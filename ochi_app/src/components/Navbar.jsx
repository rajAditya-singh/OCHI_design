...
function Navbar() {
    ...
    }, [lastScrollY]); // Dependency array to rerun when lastScrollY changes

    return (
        <div className={`w-full fixed z-[999] px-16 py-4 font-["Neue Montreal"] flex justify-between items-center transition-transform duration-300 ${!showNavbar ? '-top-16' : 'top-0'}`}>
            <div className="logo">
