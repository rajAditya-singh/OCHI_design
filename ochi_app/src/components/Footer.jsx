...
function Footer() {
    return (
        <div className='w-full h-screen flex bg-zinc-900 font-["Test_Founders_Grotesk_X_Condensed"] p-12'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className='heading text-[8vw]'>
                    <h1 className='uppercase -mb-5 font-semibold leading-none text-[9vw]'>EYE-</h1>
                    <h1 className='uppercase -mb-5 font-semibold leading-none text-[9vw]'>OPENING</h1>
                </div>
                <svg className='-mb-5' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-1/2 h-full'>
                <h1 className='uppercase -mb-5 font-semibold leading-none text-[9vw]'>presentations</h1>

                <div className='my-5 text-zinc-200 text-md '>
                    <p className='mb-3 font-["Neue_Montreal"]'>S:</p>
                    {["Instagram", "Behnace", "Facebook", "LinkedIn"].map((item, index) =>
                        <a key={index} href="http://www.instagram.com"><u className='underline-offset-2 block font-["Neue_Montreal"]'>{item}</u></a>
                    )}
                </div>
                ...
                <div className='w-full  flex justify-between'>
                    <div className='font-["Neue_Montreal"]'>
                        ...
                        <p><u className='underline-offset-2  text-md w-1/2'>202-1965 W 4th Ave<br />Vancouver, Canada<br /><br />30 Chukarina St<br />Lviv, Ukraine</u></p>
                    </div>
                    <div className='px-9'>
                        <p className='mb-3 font-["Neue_Montreal"]'>S:</p>
                        {["Home", "Services", "Our work", "Abour us", "Insights", "Contact us"].map((item, index) =>
                            <a key={index} href="http://www.instagram.com"><u className='underline-offset-2 block font-["Neue_Montreal"]'>{item}</u></a>
                        )}</div>
                </div>

                <div>
                    <p className=' mb-3 font-["Neue_Montreal"]'>E:</p>
